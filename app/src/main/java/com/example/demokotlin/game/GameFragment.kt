...
class GameFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.buttonGameFragmentScore3Watermelon.setOnClickListener {
        ...
        binding.buttonGameFragmentScore2Durian.setOnClickListener {
            viewModel.incrementScore(false, 2)
        }

        binding.buttonGameFragmentScore3Durian.setOnClickListener {
